...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 2718372005851230906),
      name: 'Favorite',
      lastPropertyId: const IdUid(5, 8044683202454086483),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 1024127985483982157),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 160504885875892398),
            name: 'city',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 8426761438687168128),
            name: 'country',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 5037437982462572486),
            name: 'latitude',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 8044683202454086483),
            name: 'longitude',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 2718372005851230906),
...
class Favorite_ {
  ...
  /// see [Favorite.city]
  static final city = QueryStringProperty<Favorite>(_entities[0].properties[1]);

  /// see [Favorite.country]
  static final country =
      QueryStringProperty<Favorite>(_entities[0].properties[2]);

  /// see [Favorite.latitude]
  static final latitude =
      QueryStringProperty<Favorite>(_entities[0].properties[3]);

  /// see [Favorite.longitude]
  static final longitude =
      QueryStringProperty<Favorite>(_entities[0].properties[4]);
}
